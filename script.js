...
function createPassword() { ////////// CREATE PASSWORD SECTION //////////
    ...
    <textarea maxlength="100" style="height: 81%; width: 25%; font-size: calc(1.3vw + 1.3vh);" id="passwordName" class="passwordInput"></textarea>
    ...
    <textarea maxlength="500" style="height: 81%; width: 25%;" id="additionalNotes" class="passwordInput"></textarea>
